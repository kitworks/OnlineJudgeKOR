export const m = {
  ...
  Your_password_has_been_reset: '비밀번호 초기화',
  // Save.vue
  Save: '저장',
  // Simditor.vue
  Uploading_is_in_progress: '업로드 도중입니다. 페이지에서 벗어나시겠습니까?',
